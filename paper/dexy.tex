...
assets only~(base currency and stablecoin), and two components, namely, a reference market~(in form of a liquidity pool
where anyone can trade base currency against stablecoins), and an algorithmic central bank, which is responsible for new
stablecoins issuance, and also for maintaining stablecoin peg in the reference market.
\end{abstract}
